          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <SignupDialog 
                  trigger={
                    <Button variant="gradient" className="flex items-center gap-2 text-base">
                      Request Your Demo <ArrowRight size={16} />
                    </Button>
                  }
                />
                <Button variant="outline" className="text-doc-black hover:text-doc-blue hover:border-doc-blue">
                  Learn More
                </Button>
              </div>
            </div>
