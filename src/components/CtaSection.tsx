        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-doc-blue/20 relative overflow-hidden">
          ...
          <div className="flex justify-center relative z-10">
            ...
            <div className="max-w-4xl text-center">
              ...
              <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-6 lg:gap-8 mb-8 flex flex-col md:block">
                ...
                <div className="flex items-start gap-2 justify-center md:justify-start md:col-span-2 md:justify-center">
                  <CheckCircle className="text-doc-purple shrink-0 mt-1" size={20} />
                  <p className="text-doc-gray">Save time through better educated patients</p>
                </div>
              </div>
