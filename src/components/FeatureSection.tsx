...
const FeatureSection = () => {
  ...
  return <section id="features" className="py-16 relative z-10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Scale your presence without scaling your workload</h2>
          <p className="text-lg text-doc-gray max-w-2xl mx-auto">
            Our platform helps healthcare providers create accurate patient education materials quickly and efficiently.
          </p>
        </div>
