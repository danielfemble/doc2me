...
const FeatureSection = () => {
  ...
  return (
    <section id="features" className="py-16 relative z-10 bg-gradient-to-b from-white/90 via-white/95 to-doc-blue/5">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-doc-gray max-w-2xl mx-auto">
            Our platform provides everything you need to create professional patient education
            that improves outcomes and grows your practice.
          </p>
        </div>
