...
const FeatureSection = () => {
  ...
  return <section id="key-features" className="py-16 relative z-10 bg-gradient-to-b from-white via-doc-blue-light/10 to-white/90">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-doc-black">Key Features</h2>
          <p className="text-lg text-doc-gray max-w-2xl mx-auto">
            Transform how you create and share health information with your patients
          </p>
        </div>
