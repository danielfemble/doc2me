...
const ExplanationSection = () => {
  return (
    <div className="mt-16 sm:mt-24 bg-gradient-to-r from-white/80 to-doc-blue-light/20 rounded-2xl p-6 sm:p-8 neo-glass backdrop-blur-sm">
      <h3 className="text-xl sm:text-2xl font-semibold text-center mb-8 text-doc-black">
