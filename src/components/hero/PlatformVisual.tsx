        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="relative z-10 mx-auto">
            ...
            <div className="relative w-full" style={{ aspectRatio: isMobile ? "1/1.2" : "3/2" }}>
              ...
              {/* Share with patients - LEFT BOTTOM */}
              <div className="absolute left-0 bottom-0 transform -translate-x-1/3 translate-y-1/3 neo-glass p-3 rounded-xl shadow-neon border border-white/30 z-20 animate-float-delay-200">
                <div className="flex items-center gap-3 text-xs sm:text-sm">
