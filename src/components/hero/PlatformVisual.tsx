        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="relative z-10 mx-auto">
            ...
            <div className="relative w-full" style={{ aspectRatio: isMobile ? "1/1.2" : "3/2" }}>
              ...
              {/* AI Content Support - RIGHT TOP CORNER - moved 10px higher */}
              <div className="absolute right-0 top-0 transform translate-x-1/3 -translate-y-1/3 -mt-10 neo-glass p-3 rounded-xl shadow-neon border border-white/30 z-20 animate-float-delayed">
                <div className="flex items-center gap-3 text-xs sm:text-sm">
                  <div className="bg-gradient-to-br from-[#0271e5] to-[#0258B6] text-white p-2 rounded-lg">
              ...
              {/* Share with patients - LEFT BOTTOM - moved 15px lower */}
              <div className="absolute left-0 bottom-0 transform -translate-x-1/3 translate-y-1/3 mt-15 neo-glass p-3 rounded-xl shadow-neon border border-white/30 z-20 animate-float-delay-200">
                <div className="flex items-center gap-3 text-xs sm:text-sm">
              ...
              {/* AI Content Enhancements - RIGHT BOTTOM */}
              <div className="absolute right-0 bottom-0 transform translate-x-1/3 translate-y-1/3 neo-glass p-3 rounded-xl shadow-neon border border-white/30 z-20 animate-float-delay-300">
