    ...
    <div className={`relative w-full ${className}`}>
      <div className="platform-visual-wrapper perspective-900 mx-auto">
        <div className="relative mx-auto max-w-6xl">
          ...
          {isMobile && (
            <>
              {/* Top left overlay - moved 15px lower */}
              <div className="absolute -top-4 left-4 mt-[15px] neo-glass p-3 rounded-xl shadow-neon border border-white/30 z-20 animate-float">
